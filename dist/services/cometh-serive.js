...
exports.deleteCometh = exports.addCometh = void 0;
const constants_1 = require("../constants/constants");
const axios_1 = require("axios");
// Function to add a Cometh
function addCometh(row, column, direction) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield axios_1.default.post(`${constants_1.API_URL}/comeths`, {
...
exports.addCometh = addCometh;
// Function to delete a Cometh
function deleteCometh(row, column) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield axios_1.default.delete(`${constants_1.API_URL}/comeths`, {
                data: {
                    candidateId: constants_1.CANDIDATE_ID,
                    row,
                    column,
